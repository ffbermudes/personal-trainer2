...
export default function FaqSection({ data }: FaqSectionProps) {
  ...
  return (
    <div
      className="mx-auto bg-white p-4 rounded-xl shadow-md"
      style={{ width: '100%' }}
    >
      <div className="mb-4 text-sm text-gray-500">Dúvidas diárias, 9:01 AM</div>
        ...
        {data.map((item) => (
          ...
          >
            <Accordion.Header>
              ...
              >
                <div
                  className="relative flex items-center space-x-2 rounded-xl bg-gray-100 p-2 hover:bg-[#E0F7FA] w-full"
                  style={{
                    backgroundColor:
            ...
            <Accordion.Content asChild forceMount style={{ display: 'block' }}>
              ...
              >
                <div
                  className="ml-7 mt-1 rounded-lg p-3 text-white md:ml-0"
                  style={{
                    borderRadius: '12px',
                    textAlign: 'left',
                    width: '100%',
                ...
                >
                  <div className="relative rounded-2xl bg-blue-500 px-4 py-2 text-white w-full">
                    {item.answer}
