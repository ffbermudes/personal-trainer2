...
export default function RippleButton({
  ...
  return (
    <button
      ref={buttonRef}
      className="font-jost duration-[600ms] relative flex items-center justify-center overflow-hidden rounded-full bg-primaryColor-1 p-[1.3rem] text-[1.2rem] font-medium text-[#0e352e] transition hover:text-white"
      onMouseEnter={(e) => {
